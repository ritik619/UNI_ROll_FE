...
export const endpoints = {
  ...
  students: {
    ...
    sendBookingForm: (id: string) => `students/${id}/booking`,
    ...
    aiAssistStatement:(id:string)=>`students/${id}/ai-assist-statement`,
  },
  universities: {
    list: 'universities',
  ...
  associations: {
    ...
    byAssociation: (id: string) => `course-associations/${id}`,
