...
export function AgentCard({ agent, sx, ...other }: Props) {
  return (
    <Card sx={[{ textAlign: 'center' }, ...(Array.isArray(sx) ? sx : [sx])]} {...other}>
      ...
      >
        {[
          { label: 'Follower', value: agent.totalFollowers },
          { label: 'Following', value: agent.totalFollowing },
          { label: 'Total post', value: agent.totalPosts },
        ].map((stat) => (
