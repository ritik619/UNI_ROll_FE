...
export function UniversityTableRow({ row, selected, editHref, onSelectRow, onDeleteRow, onToggleStatus }: Props) {
          ...
          <Box sx={{ gap: 2, display: 'flex', alignItems: 'center' }}>
            ...
            <Stack sx={{ typography: 'body2', flex: '1 1 auto', alignItems: 'flex-start' }}>
              ...
              <Box component="span" sx={{ color: 'text.disabled' }}>
                {row.description ? (row.description.length > 50 ? `${row.description.substring(0, 50)}...` : row.description) : 'No description'}
              </Box>
            </Stack>
          </Box>
        </TableCell>
