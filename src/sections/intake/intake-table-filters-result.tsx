import type { IIntakeTableFilters } from 'src/types/intake';
...
type Props = FiltersResultProps & {
  onResetPage: () => void;
  filters: UseSetStateReturn<IIntakeTableFilters>;
};

export function IntakesTableFiltersResult({ filters, onResetPage, totalResults, sx }: Props) {
